...
import { CheckCircle, XCircle, Loader2, MapPin, Eye, Scan } from 'lucide-react'
import { loadModels, findBestMatch, captureSnapshot } from '../services/faceService'
import { LivenessDetector, areEyesClosed } from '../services/livenessService'
import { employeeDB, attendanceDB } from '../services/db'
  ...
  async function startContinuousScanning() {
    while (scanningRef.current) {
      try {
        ...
        setMessage(`👁️ ${match.employee.name} [${modeLabel}] - कृपया डोळे मिटा`)
